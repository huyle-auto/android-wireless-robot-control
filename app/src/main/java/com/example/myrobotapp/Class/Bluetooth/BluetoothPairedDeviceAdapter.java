...
public class BluetoothPairedDeviceAdapter extends RecyclerView.Adapter<BluetoothPairedDeviceAdapter.ViewHolder> {
    ...
    public BluetoothPairedDeviceAdapter(Context context, List<BluetoothDevice> devices, onConnectedDeviceClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bluetooth_paired_device_table_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bluetoothPairedDeviceNameTextView.setText(deviceName != null ? deviceName : "Unknown Device");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView bluetoothPairedDeviceNameTextView;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            bluetoothPairedDeviceNameTextView = itemView.findViewById(R.id.bluetoothPairedDeviceNameTextView);
        }
    }
}
